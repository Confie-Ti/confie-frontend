...
class PdaScreen extends StatelessWidget {
        ...
        body: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              InkWell(
                onTap: () => Modular.to.navigate("manager-risk"),
                child: Container(
                  ...
                  child: Text("Gerenciamento de Risco", style: context.appTextStyles.smallWhite,),
                ),
              ),
              const SizedBox(
                height: 10,
              ...
              Container(
                ...
                child: Text("Memorial MPS", style: context.appTextStyles.smallWhite,),
              ),
            ],
          ),
        ));
